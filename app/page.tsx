...
export default function Home() {
  ...
  const heroSlides = language === "de"
    ? [
        { kicker: "Artist", title: "MAV+RICH", text: "Digitaler Artist. Reale Identität. Eine Marke, die über Musik hinaus wächst.", meta: "ICONUP ROSTER", image: "/mav-rich.jpg" },
    ...
    : [
        { kicker: "Artist", title: "MAV+RICH", text: "Digital artist. Real identity. A brand built beyond music.", meta: "ICONUP ROSTER", image: "/mav-rich.jpg" },
